...
public class SatelliteProperty {
    ...
    private final Map<Satellite, List<Satellite.Channel>> satelliteMap;
                ...
                switch (property.toLowerCase()) {
                    ...
                    case "language":
                        ...
                        for (Satellite.Channel channel : channelList) {
                            if (channel.get("a_pid").toLowerCase().contains(language)) {
                    ...
                    case "a_pid":
                        for (Satellite.Channel channel : channelList) {
                            if (channel.get("a_pid").toLowerCase().contains(value.toLowerCase())) {
                                channelListTemp.add(channel);
                            }
                        }
                        if (channelListTemp.size() != 0) {
                    ...
                    case "type":
                        for (Satellite.Channel channel : channelList) {
                            if (channel.get("type").toLowerCase().contains(value.toLowerCase())) {
                                channelListTemp.add(channel);
                            }
                        }
                        if (channelListTemp.size() != 0) {
                    ...
                    case "sat":
                        if (satellite.get("sat").toLowerCase().contains(value.toLowerCase())) {
